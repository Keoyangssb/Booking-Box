        ...
        <div class="all-blog-posts">
          <div class="container">
            <div class="row justify-content-center">
              <h2 class="text-center" style="font-family: Phetsarath OT;"><?php echo $lang['house'] ?></h2>
              &nbsp
              &nbsp
            ...
            <div class="col-md-4 col-sm-6" ng-repeat="data in getdata" id="getdataid">
              <div class="blog-post">
                <div class="blog-thumb">
                  <img ng-src="images/house/{{data.img}}" alt="">
                </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel" style="font-family: Phetsarath OT;"><?php echo $lang['addhouse'] ?></h5>
  ...
  $scope.ndata = {
     ...
     $scope.uploadFile = function(element){
                ...
                if ($(this).attr('id') == 'btnSaveData') {
                  if($scope.ndata != null){
                    ...
                    if($scope.ndata.itemnameen == '' || $scope.ndata.itemnameen == undefined){
                      alert('Please enter house name in English.');
                      return;
                    }
      ...
      $scope.ContentPage = function(itemid){  
        location.href = "housedetailview.php?id=" + itemid;
      }
