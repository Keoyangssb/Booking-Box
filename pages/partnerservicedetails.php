            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel" style="font-family: Phetsarath OT;"><?php echo $lang['editpartnerservice'] ?></h5>
    ...
    $scope.ndata = {
      ...
      $scope.uploadFile = function(element){
        ...
        $scope.selectdata = function(id){
          ...
          $http({ method  : 'POST',
          url :'pages/getpartnerservicelist.php',
        ...
        $scope.updateData = function() {
          ...
          $http({ method  : 'POST',
          url :'pages/updatepartnerservice.php',
          data : $scope.ndata,
          headers : {'Content-Type': 'application/x-www-form-urlencoded'} 
          }) .success(function(data) {
              alert(data);  
        ...
        $scope.DeleteHotel = function(id){
          ...
          $http({ method  : 'POST',
          url :'pages/deletepartnerservice.php',
          data : {'myid': id},
          headers : {'Content-Type': 'application/x-www-form-urlencoded'} 
          }).success(function(data){ 
            alert(data);
            window.location.href = './partnerserviceview.php';
          });  
        }
