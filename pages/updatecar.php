<?php
 ...
 {  
      ...
      $query = "UPDATE tblcar SET itemnamela='$itemnamelao',itemnameen='$itemnameeng',detailsla='$detailslao',detailsen='$detailseng',img='$img' WHERE itemid=".$itemid;  
      $Dbobj = new DbConnection(); 
      if(mysqli_query($Dbobj->getdbconnect(), $query))  
      {
          $query = "DELETE FROM tblcarimg WHERE carid=".$itemid;
          if(mysqli_query($Dbobj->getdbconnect(), $query)){
