    ...
    <section class="blog-posts grid-system" style="margin-top: 20px;">
      <div class="container" id="div_HotelDetail" ng-app="myapp" ng-controller="ctrlHotelDetail" ng-init="selectdata('<?php echo $_GET['id'] ?>')" ng-cloak>
        <div class="row" ng-repeat="data in getdata" id="getdataid">
          <div class="col-md-7">
            <div>
              <img src="images/house/{{data.img}}" alt="" class="img-fluid wc-image">
            </div>
            <br>
            <div class="row">
              <div class="col-sm-4 col-6" ng-repeat="dataimg in getdataimage">
                <div>
                  <img src="images/house/{{dataimg.imagename}}" alt="" class="img-fluid">
                </div>
                <br>
              </div>
            </div>
          ...
          <div class="col-md-5">
            ...
            <br>
            <div class="main-button" id="div_Action" ng-show="<?php echo $_SESSION['userid'] == 1 ? true : false ?>">
              <a href="#" data-toggle="modal" id="btnEdit" data-target="#edithotelmodal" style="font-family: Phetsarath OT;"><?php echo $lang['edit'] ?></a>
              <br>
              <br>
              <a href="#" style="font-family: Phetsarath OT;" id="btnDelete" ng-click="DeleteHotel('<?php echo $_GET['id'] ?>')"><?php echo $lang['delete'] ?></a>
            </div>
            <br>
          </div>
        </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel" style="font-family: Phetsarath OT;"><?php echo $lang['edithouse'] ?></h5>
                    ...
                    <div class="contact-form">
                      <form action="#" id="contact">
                        <div class="col-md-12" id="contact">
                          <div class="row">
                              <div class="col-md-12">
                                  <span style="font-family: Phetsarath OT;"><?php echo $lang['housenamelao'] ?></span>
                          ...
                          <div class="row">
                              <div class="col-md-12">
                                  <span style="font-family: Phetsarath OT;"><?php echo $lang['housenameeng'] ?></span>
                          ...
                          <table class="table table-bordered" ng-hide="ndata.images.length==0">
                            ...
                            <tbody>
                              ...
                              <td ng-hide="true"> 
                                ...
                                <td ng-hide="image.imagename == ''"><img ng-src="images/house/{{image.imagename}}" style="height: 100px; width: 100px;"></td>
  ...
  $scope.ndata = {
     ...
     $scope.uploadFile = function(element){
           ...
           if($scope.myFile != 'undefined'){
              ...
              $http.post('pages/uploadhouse.php', form_data,  
              {  
      ...
      $scope.updateData = function() {
        ...
        if($scope.ndata != null){
          if($scope.ndata.itemnamela == '' || $scope.ndata.itemnamela == undefined){
            alert('Please enter House name in Lao.');
            return;
          }
          if($scope.ndata.itemnameen == '' || $scope.ndata.itemnameen == undefined){
            alert('Please enter House name in Englsh.');
            return;
          }
      ...
      $scope.DeleteHotel = function(id){
        ...
        $http({ method  : 'POST',
        url :'pages/deletehouse.php',
        data : {'myid': id},
        headers : {'Content-Type': 'application/x-www-form-urlencoded'} 
        }).success(function(data){ 
          alert(data);
          window.location.href = './houseview.php';
        });  
      }
