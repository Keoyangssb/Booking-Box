        ...
        <div class="all-blog-posts">
          <div class="container">
            <div class="row justify-content-center">
              <h2 class="text-center" style="font-family: Phetsarath OT;"><?php echo $lang['customerservice'] ?></h2>
              &nbsp
              &nbsp
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel" style="font-family: Phetsarath OT;"><?php echo $lang['addcustomerservice'] ?></h5>
     ...
     $scope.uploadFile = function(element){
      ...
      $scope.selectdata = function(){ 
        var sessionLangId = "<?php echo $_SESSION['langid']; ?>"; 
          $http({ method  : 'POST',
          url :'http://polysolutions.la/pages/getcustomerservicelist.php',
      ...
      $scope.ContentPage = function(itemid){  
        location.href = "customerserviceview2.php?id=" + itemid;
      }
