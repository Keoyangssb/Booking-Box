...
include('/var/www/html/config.php');
 ...
 {  
      ...
      $query = "select max(itemid) as xid from tblpartnerservice";
      ...
      $query = "INSERT INTO tblpartnerservice(itemid,itemnamela,itemnameen,detailsla,detailsen,tel1,img) VALUES ($itemid, '$hotelnamelao','$hotelnameeng','$detailslao','$detailseng','$tel1', '')";  
