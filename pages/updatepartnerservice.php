...
include('/var/www/html/config.php');
 ...
 {  
      ...
      $query = "UPDATE tblpartnerservice SET itemnamela='$hotelnamelao',itemnameen='$hotelnameeng',detailsla='$detailslao',detailsen='$detailseng',tel1='$tel1',img='' WHERE itemid=".$itemid;  
