...
<html lang="en">
  ...
  <body>
    ...
    <section class="blog-posts grid-system" style="margin-top: 20px;">
      <div class="container" id="div_Data" ng-app="myapp" ng-controller="guesthouselist" ng-init="selectdata()" ng-cloak>
        <div class="all-blog-posts">
          <div class="container">
            <div class="row justify-content-center">
              <h2 class="text-center" style="font-family: Phetsarath OT;"><?php echo $lang['room'] ?></h2>
              &nbsp
              &nbsp
            ...
            <div class="col-md-4 col-sm-6" ng-repeat="data in getdata" id="getdataid">
              <div class="blog-post">
                <div class="blog-thumb">
                  <img ng-src="images/rooms/{{data.img}}" alt="">
                </div>
            ...
            <div class="modal-dialog modal-lg" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel" style="font-family: Phetsarath OT;"><?php echo $lang['addroom'] ?></h5>
                  ...
                  <div class="contact-us">
                    <div class="contact-form">
                      <form action="#" id="contact">
                        <div class="row">
                            <div class="col-md-12">
                                <span style="font-family: Phetsarath OT;"><?php echo $lang['roomnamelao'] ?></span>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <span style="font-family: Phetsarath OT;"><?php echo $lang['roomnameeng'] ?></span>
                          ...
                          <table class="table table-bordered" ng-hide="ndata.images.length==0">
                            ...
                            <tbody>
                              ...
                              <td ng-hide="true"> 
                                ...
                                <td ng-hide="image.imagename == ''"><img ng-src="images/rooms/{{image.imagename}}" style="height: 100px; width: 100px;"></td>
...
$(document).ready(function () {
 ...
 app.controller("guesthouselist", function($scope, $http){
  $scope.ndata = {
          "id": "",
          "itemnamela": "",
          "itemnameen": "",
     ...
     $scope.uploadFile = function(element){
           ...
           if($scope.myFile != 'undefined'){
              ...
              $http.post('pages/uploadroom.php', form_data,  
              {  
                ...
                if ($(this).attr('id') == 'btnSaveData') {
                  if($scope.ndata != null){
                    ...
                    if($scope.ndata.itemnameen == '' || $scope.ndata.itemnameen == undefined){
                      alert('Please enter room name in English.');
                      return;
                    }
      ...
      $scope.ContentPage = function(itemid){  
        location.href = "roomdetailview.php?id=" + itemid;
      }
