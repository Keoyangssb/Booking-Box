<!DOCTYPE html>  
 <html>  
      ...
      <body>  
           <br />  
           <h3>File Upload Using AngularJS with PHP Script</h3><br />  
           <br />  
           <div class="container" ng-app="myapp" ng-controller="myController" ng-init="select()">  
                <div class="col-md-4">  
                     <input type="file" file-input="files" name="file" id="file"/>  
                </div>  
                <div class="col-md-6">  
                ...
                <div class="col-md-3" ng-repeat="image in ndata.images">  
