  ...
  <body>
    ...
    <header class="">
      <nav class="navbar navbar-expand-lg">
        <div class="container">
          <a class="navbar-brand" href="index.html"><h2>Vacation Rental Website<em>.</em></h2></a>
            ...
            <div class="col-md-4 col-sm-6">
              <div class="blog-post">
                ...
                <div class="down-content">
                  <span> $500.00 - $700.00 </span>
                  <a href="vacations.html"><h4>Lorem ipsum dolor sit amet, consectetur</h4></a>
                    ...
                    <div class="row">
                      <div class="col-lg-12">
                        <ul class="post-tags">
                          ...
                          <li><a href="vacation-details.html">View Vacation</a></li>
                        </ul>
                      </div>
                    </div>
                  </div>
